...
program.name("create-react-template").description("Scaffold a TanStack Start + React 19 + FSD app").argument("[project-name]", "Name of the new project").action(
  async (projectNameArg) => {
