...
import { TEMPLATE_README_URL } from '#/shared/config/repo-links';
import { Button } from '#/shared/ui';
import { DEV_COMMANDS } from './constants';
...
export function LaunchCard({
  ...
  return (
    ...
    >
      <CodeBlock ref={codeBlockRef} code={DEV_COMMANDS[pm]} />
    </StepCard>
  );
}
